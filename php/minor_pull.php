...
##
##	minor_pull.php:
##	A php document that pulls the minor wanted and prints it to an external file
#####################################################################################################################################
*/
	...
	try {
		...
		$stmt = 'SELECT * FROM current_students_entries WHERE Minor_1 = \''.$minor. '\' or Minor_2 = \''.$minor.'\'';
