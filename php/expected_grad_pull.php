...
##
##	expected_grad_pull.php:
##	A php document that pulls the expected grad date wanted and prints it to an external file
#####################################################################################################################################
*/
	...
	try {
		...
		$stmt = 'SELECT * FROM current_students_entries WHERE Expected_Grad_Date = \'' .$EGD .'\'';
