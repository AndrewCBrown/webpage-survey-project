...
##
##	majors_pull.php:
##	A php document that pulls the majors wanted and prints it to an external file
#####################################################################################################################################
*/
	...
	try {
		...
		$stmt = 'SELECT * FROM current_students_entries WHERE Major_1= \'' .$major. '\' or Major_2 = \'' .$major. '\' or Major_3 = \'' .$major. '\'';
