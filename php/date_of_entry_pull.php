...
##
##	date_of_entry_pull.php:
##	A php document that pulls the date of entry wanted and prints it to an external file
#####################################################################################################################################
*/
	...
	try {
	  ...
	  $stmt = 'SELECT * FROM current_students_entries WHERE Expected_Grad_Date = \'' .$date_of_entryvar1. '\'';
