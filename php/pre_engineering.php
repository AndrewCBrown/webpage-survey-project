...
##
##	pre_engineering.php:
##	A php document that pulls whether or not they are pre engineering and prints it to an external file
#####################################################################################################################################
*/
	...
	try {
		...
		$stmt = 'SELECT * FROM current_students_entries WHERE Pre_Engineering = \''.$preengineeringvar.'\'';
